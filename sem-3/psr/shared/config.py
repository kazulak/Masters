...
OPEN_LIBRARY_TIMEOUT_SECONDS = float(env("OPEN_LIBRARY_TIMEOUT_SECONDS", "25"))
...
OLLAMA_GENERATE_MODEL = env("OLLAMA_GENERATE_MODEL", "gemma4:e2b")
OLLAMA_NUM_PREDICT = int(env("OLLAMA_NUM_PREDICT", "512"))
OLLAMA_TIMEOUT_SECONDS = float(env("OLLAMA_TIMEOUT_SECONDS", "240"))
