...
#define EXECUTION_PLAN_PROVIDER_MAX_DPUS EXECUTION_PLAN_V3_MAX_DPUS
#else
#define EXECUTION_PLAN_PROVIDER_MAX_DPUS EXECUTION_PLAN_MAX_DPUS
#endif
...
dpu_error_t execution_plan_provider_init(
    ...
    if (provider == NULL || requested_dpus < 1u || requested_dpus > EXECUTION_PLAN_PROVIDER_MAX_DPUS ||
