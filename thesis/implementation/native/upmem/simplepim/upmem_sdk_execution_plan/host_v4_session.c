...
static execution_plan_provider_t v4_provider;
...
static void v4_emit_release(void) {
    ...
    if (v4_provider_initialized) {
        ...
        error = execution_plan_provider_release(&v4_provider);
    }
...
int main(int argc, char **argv) {
    ...
    error = execution_plan_provider_init_on_rank(&v4_provider, dpus, rank_path, initialization_binary);
