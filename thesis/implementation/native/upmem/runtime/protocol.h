...
#define EXECUTION_PLAN_V4_INT8_COMPONENT_PRODUCT \
    (2u * EXECUTION_PLAN_V4_INT8_MAX_ABS * EXECUTION_PLAN_V4_INT8_MAX_ABS)
...
_Static_assert((uint64_t)EXECUTION_PLAN_V4_MAX_CONTRACTED *
    ...
    "v4 full-component int32 accumulation bound is unsafe");
