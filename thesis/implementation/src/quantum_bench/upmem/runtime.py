...
class UpmemV4Session:
            ...
            for lane, (lane_left, lane_right) in zip(
                ...
                for wave_index, wave in enumerate(waves):
                    ...
                    request_payload_materialization_sum_s += float(
                        metrics["request_payload_materialization_s"]
                    )
                    request_payload_file_write_sum_s += float(
                        metrics["request_payload_file_write_s"]
                    )
                    request_payload_hashing_sum_s += float(
                        metrics["request_payload_hashing_s"]
                    )
                    request_payload_record_construction_sum_s += float(
                        metrics["request_payload_record_construction_s"]
                    )
    ...
    def _submit_wave(
        ...
        *,
        ...
        request_payload_materialization_s = 0.0
        request_payload_file_write_s = 0.0
        request_payload_hashing_s = 0.0
        request_payload_record_construction_s = 0.0
        request_payload_record_count = 0
        request_payload_files_created = 0
        request_payload_bytes_staged = 0
        request_payload_bytes_hashed = 0
        for rank, assignments in requests:
            ...
            request_payload_materialization_s += artifact.payload_materialization_s
            request_payload_file_write_s += artifact.payload_file_write_s
            request_payload_hashing_s += artifact.payload_hashing_s
            request_payload_record_construction_s += (
        ...
        try:
            ...
            request_metrics: dict[str, Any] = {
                ...
                "request_payload_materialization_s": request_payload_materialization_s,
                "request_payload_file_write_s": request_payload_file_write_s,
                "request_payload_hashing_s": request_payload_hashing_s,
                "request_payload_record_construction_s": (
                    request_payload_record_construction_s
                ),
                "request_payload_record_count": request_payload_record_count,
