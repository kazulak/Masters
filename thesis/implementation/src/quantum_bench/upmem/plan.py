...
UPMEM_PROFILE_ID = NATIVE_EXECUTION_IDENTITY["profile"]
UPMEM_ABI_ID = NATIVE_EXECUTION_IDENTITY["abi"]
UPMEM_SESSION_ID = NATIVE_EXECUTION_IDENTITY["session_protocol"]
UPMEM_DISPATCH_ID = NATIVE_EXECUTION_IDENTITY["dispatch_mode"]
UPMEM_KERNEL_ID = NATIVE_EXECUTION_IDENTITY["kernel_identity"]
