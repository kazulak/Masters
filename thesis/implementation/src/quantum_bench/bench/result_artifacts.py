...
RESULT_FIELDS = [
    ...
    "left_quantization_clipping_count",
    "right_quantization_clipping_count",
    "left_quantization_saturation_count",
    "right_quantization_saturation_count",
    "left_quantization_scale",
    "right_quantization_scale",
    "quantization_scales",
    "complex_representation",
    "complex_split_complex_task_count",
    "full_precision_reference_kind",
    "full_precision_max_abs_error",
    "full_precision_l2_error",
    "full_precision_relative_l2_error",
    "input_dtype_on_dpu",
    ...
    "total_host_residual_time_s",
    "host_residual_time_kind",
    "total_bridge_time_s",
    "total_build_time_s",
    "execution_scope",
    ...
    record.update(
        {
            ...
            "total_bridge_time_s": summary.get("total_bridge_time_s"),
            ...
            "complex_split_complex_task_count": summary.get("complex_split_complex_task_count"),
            "full_precision_reference_kind": full_precision_accuracy.get("full_precision_reference_kind") or full_precision_accuracy.get("reference_kind"),
            "full_precision_max_abs_error": full_precision_accuracy.get("full_precision_max_abs_error")
            if full_precision_accuracy.get("full_precision_max_abs_error") is not None
            else full_precision_accuracy.get("max_abs_error"),
            "full_precision_l2_error": full_precision_accuracy.get("full_precision_l2_error")
            if full_precision_accuracy.get("full_precision_l2_error") is not None
            else full_precision_accuracy.get("l2_error"),
            "full_precision_relative_l2_error": full_precision_accuracy.get("full_precision_relative_l2_error")
            if full_precision_accuracy.get("full_precision_relative_l2_error") is not None
            else full_precision_accuracy.get("relative_l2_error"),
...
def _base_record(
    *,
    ...
    return {
        ...
        "plan_reused": None,
        "planning_in_timed_region": None,
        "executor_config_hash": None,
        ...
        "left_quantization_clipping_count": None,
        "right_quantization_clipping_count": None,
        "quantization_clipping_count": None,
        "left_quantization_saturation_count": None,
        "right_quantization_saturation_count": None,
        ...
        "complex_split_complex_task_count": None,
        ...
        "total_simulator_time_s": None,
        "total_host_orchestration_time_s": None,
        "total_host_residual_time_s": None,
        "host_residual_time_kind": None,
        "total_bridge_time_s": None,
        "total_build_time_s": None,
...
def normalize_parallelism_metadata(record: JsonDict) -> JsonDict:
    ...
    normalized.setdefault("circuit_semantics_hash", None)
    normalized.setdefault("tensor_network_hash", None)
    normalized.setdefault("contraction_plan_hash", None)
