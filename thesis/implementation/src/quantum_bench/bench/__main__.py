...
def main() -> int:
    ...
    upmem_hardware_m4_3_parser = sub.add_parser(
        "upmem-hardware-simplepim-taskgraph-m4-3",
    ...
    upmem_hardware_m4_4_parser = sub.add_parser(
        "upmem-hardware-simplepim-chain-m4-4",
