...
BACKEND_LABELS = {
    ...
    "cpu_tn_frontier_exact": "Internal CPU TN frontier",
    "cpu_tn_hybrid_sliced_frontier_exact": "Internal CPU TN hybrid",
    "cpu_tn_path_replay_float64": "CPU TN path replay",
    "cpu_tn_path_replay_int8_quantized": "CPU TN quantized replay",
