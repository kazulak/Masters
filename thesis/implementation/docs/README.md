...
Active documentation for the tensor-network quantum-circuit benchmarking
system. Start with the repository [README](../README.md), then use the
architecture and roadmap below.

| Document | Use it for |
| --- | --- |
| [../ARCHITECTURE.md](../ARCHITECTURE.md) | Current module ownership, execution boundaries, and claim limits. |
