...
def build_selection(record: Mapping[str, object]) -> dict[str, object]:
    ...
    basis = {
        ...
        "selection_rule": {"anchor_case_id": anchor_id, "low_case_rule": ["smallest_largest_non_final_intermediate_elements", "planner_flops_estimate", "candidate_id"], "distinct_case_rule": "maximize_minimum_normalized_euclidean_distance_from_anchor_and_low_case", "distance_fields": list(fields), "normalization": "min_max_over_all_four_candidates_constant_fields_zero", "timing_used": False},
        "candidates": [{"candidate_id": candidate["candidate_id"], "circuit": candidate["circuit"], "problem_id": candidate["problem_id"], "tensor_network_structure_id": candidate["tensor_network_structure_id"], "tensor_network": candidate["tensor_network"], "selection_descriptors": descriptors[candidate["candidate_id"]], "distances": distances[candidate["candidate_id"]]} for candidate in candidates],
